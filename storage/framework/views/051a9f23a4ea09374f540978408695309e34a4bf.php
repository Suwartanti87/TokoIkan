...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo e(asset('img/favicon.')); ?>" rel="icon">
  <link href="<?php echo e(asset('img/apple-touch-icon.')); ?>" rel="apple-touch-icon">
  ...
  <link href="<?php echo e(asset('vendor/owl.carousel/owl.carousel.min.css')); ?>" rel="stylesheet">
...
<body>
  ...
  <?php echo $__env->make('layout.about', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("<?php echo e(asset('img/toko.gif')); ?> ");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="<?php echo e(asset('img/skills.png')); ?>" class="img-fluid" alt="">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><img src="<?php echo e(asset('img/ikan/arwana.jpg')); ?>" class="img-fluid" alt=""></div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><img src="<?php echo e(asset('img/ikan/lohan.png')); ?>" class="img-fluid" alt=""></div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><img src="<?php echo e(asset('img/ikan/bluerim.jpg')); ?>" class="img-fluid" alt=""></div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              <div class="icon"><img src="<?php echo e(asset('img/ikan/channa.jpg')); ?>" class="img-fluid" alt=""></div>
   ...
   <?php echo $__env->make('layout.kategori', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="<?php echo e(asset('img/team/betta.jpg')); ?>" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="<?php echo e(asset('img/team/betacare.jpg')); ?>" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>BettaCARE</h4>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="<?php echo e(asset('img/team/betadin.jpg')); ?>" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Bettadin</h4>
                <span>CTO</span>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
              <div class="pic"><img src="<?php echo e(asset('img/team/buayi.jpg')); ?>" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Buayiau Betta</h4>
...
</html><?php /**PATH C:\xampp\htdocs\TokoIkan\resources\views/layout/home.blade.php ENDPATH**/ ?>